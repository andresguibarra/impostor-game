  ...
  <div class="flex flex-col items-center justify-center min-h-screen p-4 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    ...
    <div class="neon-card-impostor shadow-2xl p-8 max-w-lg w-full relative z-10">
      ...
      <div class="text-center mb-6">
        ...
        <div class="bg-gradient-to-br from-cyan-600/90 to-blue-600/90 backdrop-blur-md rounded-2xl p-5 mb-4 shadow-[0_0_30px_rgba(6,182,212,0.5)] border-2 border-cyan-400/50">
          <p class="text-sm text-white font-bold mb-1 opacity-90">📍 SESIÓN:</p>
          <p class="text-4xl font-black text-white tracking-[0.2em] [text-shadow:0_0_20px_rgba(255,255,255,0.5)]">
            {{ sessionCode }}
          </p>
        </div>
